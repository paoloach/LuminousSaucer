...
public inline fun listEntitiesButtonResponse(block: it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse =
  it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponseKt.Dsl._create(it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse.newBuilder()).apply { block() }._build()
public object ListEntitiesButtonResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse.copy(block: it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponse =
  it.achdjian.saucer.luminous.protobuf.ListEntitiesButtonResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
