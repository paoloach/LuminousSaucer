...
public inline fun listEntitiesCameraResponse(block: it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse =
  it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponseKt.Dsl._create(it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse.newBuilder()).apply { block() }._build()
public object ListEntitiesCameraResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse.copy(block: it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponse =
  it.achdjian.saucer.luminous.protobuf.ListEntitiesCameraResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
