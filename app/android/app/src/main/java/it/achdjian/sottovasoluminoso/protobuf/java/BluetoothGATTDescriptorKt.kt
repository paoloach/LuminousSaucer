...
public inline fun bluetoothGATTDescriptor(block: it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptorKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor =
  it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptorKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor.newBuilder()).apply { block() }._build()
public object BluetoothGATTDescriptorKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptorKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptor =
  it.achdjian.sottovasoluminoso.protobuf.java.BluetoothGATTDescriptorKt.Dsl._create(this.toBuilder()).apply { block() }._build()
