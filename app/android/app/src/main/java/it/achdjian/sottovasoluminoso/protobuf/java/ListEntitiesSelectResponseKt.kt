...
public inline fun listEntitiesSelectResponse(block: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponseKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse.newBuilder()).apply { block() }._build()
public object ListEntitiesSelectResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesSelectResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
