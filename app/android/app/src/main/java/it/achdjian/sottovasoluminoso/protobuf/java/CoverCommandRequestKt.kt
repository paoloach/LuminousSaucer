...
public inline fun coverCommandRequest(block: it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequestKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest =
  it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequestKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest.newBuilder()).apply { block() }._build()
public object CoverCommandRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest = _builder.build()
     ...
     */
    public var legacyCommand: it.achdjian.sottovasoluminoso.protobuf.java.LegacyCoverCommand
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequestKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequest =
  it.achdjian.sottovasoluminoso.protobuf.java.CoverCommandRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
