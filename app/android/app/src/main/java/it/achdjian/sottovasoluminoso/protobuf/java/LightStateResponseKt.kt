...
public inline fun lightStateResponse(block: it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponseKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse.newBuilder()).apply { block() }._build()
public object LightStateResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse = _builder.build()
     ...
     */
    public var colorMode: it.achdjian.sottovasoluminoso.protobuf.java.ColorMode
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.LightStateResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
