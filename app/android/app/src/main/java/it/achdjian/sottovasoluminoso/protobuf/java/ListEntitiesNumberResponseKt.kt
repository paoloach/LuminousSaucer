...
public inline fun listEntitiesNumberResponse(block: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponseKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse.newBuilder()).apply { block() }._build()
public object ListEntitiesNumberResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse = _builder.build()
     ...
     */
    public var mode: it.achdjian.sottovasoluminoso.protobuf.java.NumberMode
      @JvmName("getMode")
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesNumberResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
