...
public inline fun listEntitiesBinarySensorResponse(block: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponseKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse.newBuilder()).apply { block() }._build()
public object ListEntitiesBinarySensorResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponseKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponse =
  it.achdjian.sottovasoluminoso.protobuf.java.ListEntitiesBinarySensorResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
