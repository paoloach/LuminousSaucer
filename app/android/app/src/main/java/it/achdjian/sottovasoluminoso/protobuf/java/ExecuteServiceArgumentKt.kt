...
public inline fun executeServiceArgument(block: it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgumentKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument =
  it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgumentKt.Dsl._create(it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument.newBuilder()).apply { block() }._build()
public object ExecuteServiceArgumentKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument.copy(block: it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgumentKt.Dsl.() -> kotlin.Unit): it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgument =
  it.achdjian.sottovasoluminoso.protobuf.java.ExecuteServiceArgumentKt.Dsl._create(this.toBuilder()).apply { block() }._build()
